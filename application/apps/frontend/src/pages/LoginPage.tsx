...
import { Salad, Mail, Lock, Sparkles, ArrowRight, AlertCircle, Loader2 } from 'lucide-react';

export const LoginPage: React.FC = () => {
  const [email, setEmail] = useState<string>('demo@foodlens.ai');
  const [password, setPassword] = useState<string>('TestPass123!');
  ...
  return (
    <div className="mx-auto max-w-md space-y-8 pt-8 pb-16">
      ...
      <div className="fixed top-1/4 left-1/2 -translate-x-1/2 h-96 w-96 rounded-full bg-emerald-500/10 blur-[140px] pointer-events-none -z-10" />
      ...
      <div className="text-center space-y-3">
        ...
        <h1 className="text-3xl font-black text-white heading-font">
          Welcome to <span className="gradient-text-emerald">FoodLens AI</span>
        </h1>
        <p className="text-xs text-slate-400">Log in to manage food scans and nutrition insights</p>
      </div>
